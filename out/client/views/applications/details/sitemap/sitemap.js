...
Template.ApplicationsDetailsSitemap.rendered = function() {
	
};

Template.ApplicationsDetailsSitemap.events({
	
});

Template.ApplicationsDetailsSitemap.helpers({
	
});



Template.ApplicationsDetailsSitemapMap.rendered = function() {
	var self = this;
	...
	var drawSitemap = function() {
		...
		svgGroup.selectAll(".node").on("click", function(d, i) {
			Router.go("applications.details.sitemap", { applicationId: self.data.params.applicationId, objectId: d, propertyName: null });
		});
	};
...
Template.ApplicationsDetailsSitemapMap.events({
	
});

Template.ApplicationsDetailsSitemapMap.helpers({
...
Template.ApplicationsDetailsSitemapForm.rendered = function() {
...
Template.ApplicationsDetailsSitemapForm.helpers({
...
Template.ApplicationsDetailsSitemapForm.events({
	...
	"click .object-array-table tr": function(e, t) {
		e.preventDefault();
		Router.go("applications.details.sitemap", { applicationId: this.rootId, objectId: this.objectId, propertyName: null });
		return false;
	},
	...
	"click .object-tab-item": function(e, t) {
		e.preventDefault();
		Router.go("applications.details.sitemap", { applicationId: this.applicationId, objectId: this.objectId, propertyName: this.propertyName });
	}
});

Template.ApplicationsDetailsSitemapFormGenericArrayView.helpers({
